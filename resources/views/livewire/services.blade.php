...
<div>
    ...
    <section class="exclusive-offers-area-four pt-100 pb-70">
        <div class="container">
            ...
            <video class="w-full mb-6" controls>
                <source src="{{ asset('videos/servicios.mp4') }}" type="video/mp4">
    ...
    $stars = round(
        ...
        2,
                                            ...
                                            <a href="{{ route('appointments', ['service_id' => $service->id]) }}" class="default-btn">
                                                Reserva en línea
                                                ...
                                                <div class="flex gap-3">
                                                    ...
                                                    @if ($user->hasAnyRole(['admin', 'employee']) && $match)
                                                        <x-lucide-pencil class="w-5 h-5 hover:text-blue-600 cursor-pointer"
                                                            wire:click="$dispatch('edit', { record: {{ $service->id }}})" title="Editar" />
                                                    @endif
                                                    @role('admin')
